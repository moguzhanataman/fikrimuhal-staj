...
object Customer {
  ...
  val all = Seq(
    ...
    Customer(3, "Mehmet", photoData, 1409061949, 1),
    Customer(4, "Mehmet", photoData, 1409061949, 1),
    Customer(5, "Mehmet", photoData, 1409061949, 1),
    Customer(6, "Mehmet", photoData, 1409061949, 1),
    Customer(7, "Mehmet", photoData, 1409061949, 1),
    Customer(8, "Mehmet", photoData, 1409061949, 1),
